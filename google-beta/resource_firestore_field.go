...
func resourceFirestoreFieldDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return handleNotFoundError(err, d, "Field")
	}

	err = firestoreOperationWaitTime(
		config, res, project, "Deleting Field",
...
func resourceFirestoreFieldImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	...
	log.Printf("[DEBUG] Setting bunch a feilds database, collection, name to %s", name)
...
func flattenFirestoreFieldIndexConfigIndexesFields(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	...
	transformed["field_path"] =
		flattenFirestoreFieldIndexConfigIndexesFieldsFieldPath(original["fieldPath"], d, config)
	transformed["order"] =
		flattenFirestoreFieldIndexConfigIndexesFieldsOrder(original["order"], d, config)
	transformed["array_config"] =
		flattenFirestoreFieldIndexConfigIndexesFieldsArrayConfig(original["arrayConfig"], d, config)
	return []interface{}{transformed}
}
