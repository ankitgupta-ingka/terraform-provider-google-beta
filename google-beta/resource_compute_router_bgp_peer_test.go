...
func TestAccComputeRouterPeer_enable(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccComputeRouterPeerEnable(testId, false),
				Check: testAccCheckComputeRouterPeerExists(
					"google_compute_router_peer.foobar"),
			},
			{
			...
			{
				Config: testAccComputeRouterPeerEnable(testId, true),
				Check: testAccCheckComputeRouterPeerExists(
					"google_compute_router_peer.foobar"),
			},
			{
...
func TestAccComputeRouterPeer_bfd(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccComputeRouterPeerBfd(testId, "ACTIVE"),
				Check: testAccCheckComputeRouterPeerExists(
					"google_compute_router_peer.foobar"),
			},
			{
			...
			{
				Config: testAccComputeRouterPeerBfd(testId, "PASSIVE"),
				Check: testAccCheckComputeRouterPeerExists(
					"google_compute_router_peer.foobar"),
			},
			{
...
func testAccComputeRouterPeerEnable(testId string, enable bool) string {
	return fmt.Sprintf(`
resource "google_compute_network" "foobar" {
  name                    = "router-peer-test-%s"
  auto_create_subnetworks = false
...
`, testId, testId, testId, testId, testId, testId, testId, testId, testId, testId, testId, enable)
}

func testAccComputeRouterPeerBfd(testId, bfdMode string) string {
	return fmt.Sprintf(`
resource "google_compute_network" "foobar" {
  name                    = "router-peer-test-%s"
  auto_create_subnetworks = false
...
`, testId, testId, testId, testId, testId, testId, testId, testId, testId, testId, testId, bfdMode)
}
